...
public:
    ...
    void setupUi(QDialog *UserInfoDialog)
    {
        ...
        alter_portrait_pushButton->setMinimumSize(QSize(0, 30));
        QFont font;
        font.setFamilies({QString::fromUtf8("Microsoft YaHei UI")});
        font.setPointSize(13);
        font.setBold(true);
        alter_portrait_pushButton->setFont(font);
        alter_portrait_pushButton->setCursor(QCursor(Qt::PointingHandCursor));
        ...
        user_name_lineEdit->setMinimumSize(QSize(0, 30));
        QFont font1;
        font1.setPointSize(13);
        font1.setBold(true);
        user_name_lineEdit->setFont(font1);
        user_name_lineEdit->setAlignment(Qt::AlignCenter);
    ...
    void retranslateUi(QDialog *UserInfoDialog)
    {
        ...
        user_name_lineEdit->setPlaceholderText(QCoreApplication::translate("UserInfoDialog", "\350\257\267\350\276\223\345\205\245\346\230\265\347\247\260", nullptr));
