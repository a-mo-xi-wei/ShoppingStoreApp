...
public:
    ...
    void setupUi(QDialog *DetailDlg)
    {
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 1127, 775));
    ...
    void retranslateUi(QDialog *DetailDlg)
    {
        ...
        address_label->setText(QCoreApplication::translate("DetailDlg", "   \345\234\260\345\235\200\344\277\241\346\201\257", nullptr));
